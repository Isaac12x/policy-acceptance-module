...
type DashboardAIAssistantConfig = NonNullable<
  ComponentProps<typeof PolicyAcceptanceDashboard>["aiAssistant"]
>;

const mockAIAssistant: DashboardAIAssistantConfig = {
  ...
  brandColor: "hsl(221.2 83.2% 53.3%)", // Blue color matching legal theme
  allowMinimize: true,
};
  ...
  return (
    <PolicyAcceptanceProvider config={config}>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        <PolicyAcceptanceDashboard aiAssistant={mockAIAssistant} />
      </div>
    </PolicyAcceptanceProvider>
  );
}
